    ...
    let n = {
        ...
        Nav_Menu: function(t) {
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(i) {
                    ...
                    t.find(".elementskit-dropdown-has").not(o).find(">.elementskit-dropdown, >.elementskit-megamenu-panel").removeClass("ekit-dropdown-open-onclick"),
        ...
        Back_To_Top: function(t) {
            const n = t.find(".ekit-btt__button")
              , {offset_top: i, show_after: s, show_scroll: o, style: a, foreground: l, background: d} = t.find(".ekit-btt").data("settings");
